...
public class HTMLReport {
	...
	def static String GenerateReport(){
		//Excel iExcel
		...
		for(int i = 0; i < TestCaseNames.size(); i++) {
			//int i = 2
			String newCaseStatus = "<tr style='mso-yfti-irow:4;mso-yfti-lastrow:yes;height:27.0pt'><td align='center' width=\"15%\" style='width:15.0%;padding:.75pt .75pt .75pt .75pt;height:27.0pt'><p class=MsoNormal><span style='mso-fareast-font-family:\"Times New Roman\"'>" +
					(i+1).toString() + "</span></p></td><td width=\"50%\" style='width:50.0%;padding:.75pt .75pt .75pt .75pt;height:27.0pt'><pre class=MsoNormal><span style='mso-fareast-font-family:\"Times New Roman\"'>" +
					TestCaseNames.get(i).toString() + "</span></pre></td><td width=\"15%\" style='width:15.0%;padding:.75pt .75pt .75pt .75pt;height:27.0pt'><p class=MsoNormal><span style='mso-fareast-font-family:\"Times New Roman\"'>" +
					TestCaseIterations.get(i).toString() + "</span></p></td>"
			String status = TestCaseStatus.get(i).toString()
			if(status == "PASSED")
				newCaseStatus = newCaseStatus + "<td width=\"20%\" style='width:20.0%;padding:.75pt .75pt .75pt .75pt;height:27.0pt'><p class=MsoNormal><span style='mso-fareast-font-family:\"Times New Roman\";color:green'>PASSED</span></p></td>"
			else
				newCaseStatus = newCaseStatus + "<td width=\"20%\" style='width:20.0%;padding:.75pt .75pt .75pt .75pt;height:27.0pt'><p class=MsoNormal><span style='mso-fareast-font-family:\"Times New Roman\";color:red'>" +
						status + "</span></p></td>"
