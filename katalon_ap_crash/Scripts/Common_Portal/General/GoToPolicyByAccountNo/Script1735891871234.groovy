...
WebUI.callTestCase(findTestCase('Common_Portal/Actions/InputTextBoxValueByContainsText'), [('text') : 'Search by keyword', ('value') : accountNumber], FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('AgencyPortal/Dynamic/Div/divByContainsText', [('text') : 'Account Summary']), 5)

WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickTabLinkByIndex'), [('index') : '2'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickLinkByContainsText'), [('text') : policyNumber], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('AgencyPortal/Dynamic/Div/divByContainsText', [('text') : 'Policy Summary']), 5)