...
WebUI.uploadFile(findTestObject('Common/Dynamic/Input/inputByType',[('type') : 'file']), fullPath)

WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickBtnByContainsText'), [('text') : 'Done', ('wait') : true], FailureHandling.STOP_ON_FAILURE)
