...
WebUI.callTestCase(findTestCase('Common_Portal/Actions/InputTextBoxValueByContainsText'), [('text') : 'Search by keyword', ('value') : submissionNumber], FailureHandling.STOP_ON_FAILURE)
...
if (WebUI.verifyElementAttributeValue(findTestObject('AgencyPortal/Dynamic/Input/inputByLabelText', [('text') : 'Search by keyword']), 'aria-expanded', 'true', 2, FailureHandling.OPTIONAL)) {
	...
	// Input text expand
	println('>>>Input QUOTES Expanded>>>...')
	
	WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickSpanOptionByText'), [('text') : 'Quotes'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickBtnByContainsText'), [('text') : 'View Quote', ('wait') : true], FailureHandling.STOP_ON_FAILURE)
