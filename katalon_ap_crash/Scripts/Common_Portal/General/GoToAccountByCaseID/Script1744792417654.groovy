...
accountNumber = WebUI.callTestCase(findTestCase('Common/SQLFunctions/SQL_SELECT'), [('testName') : caseID, ('dataColumn') : 'Account#'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('Common/Dynamic/Div/divByContainsText', [('text') : 'Account Summary']), 5)
