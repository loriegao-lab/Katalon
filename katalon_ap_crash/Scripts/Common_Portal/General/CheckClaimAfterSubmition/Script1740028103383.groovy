...
WebUI.verifyElementVisible(findTestObject('AgencyPortal/Dynamic/Link/linkByText', [('text') : claimNum]),
...
'Account Level Check'
WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickLinkByHeadingText'), [('heading') : 'Helpful Links', ('text') : 'View Account Details'], FailureHandling.STOP_ON_FAILURE)
