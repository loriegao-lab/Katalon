...
WebUI.callTestCase(findTestCase('Common_Portal/Actions/InputTextBoxValueByText'), [('text') : 'Search by keyword', ('value') : policyNumber, ('wait') : true],
...
WebUI.callTestCase(findTestCase('Common_Portal/Actions/ClickBtnByContainsText'), [('text') : 'View Policy'], FailureHandling.STOP_ON_FAILURE)
