...
CustomKeywords.'encova.WebAuthenticator.loginWithGoogle'(username, password, false)
...
WebUI.switchToWindowTitle('Encova Insurance - Dev - Sign In')
...
WebUI.click(findTestObject('AgencyPortal/Dynamic/Link/linkByHeadingAndText', [('heading') : 'Password', ('text'): 'Set up']))
